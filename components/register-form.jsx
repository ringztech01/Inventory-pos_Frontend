...
export function RegisterForm() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
        ...
        //Step 1: Rgister with only emil/password/user
        ...
        //Stet 2: Update user with firstName and lastName
    ...
    if(!res?.error){
        ...
        toast.error("Login failed after registration, Please try to login");
    }
